...
class LeetCodeStudyPlanClient:
    ...
    def join_study_plan(self, plan_slug: str, weekly_task_schedule: Optional[List[int]] = None) -> bool:
        payload = {
            "query": """
            ...
            """,
            "variables": {"slug": plan_slug, "weeklyTaskSchedule": weekly_task_schedule},
    ...
    def study_plan_progress(self, plan_slug: str, history_id: Optional[str] = None) -> Optional[Dict]:
        payload = {
            "query": """
